                    ...
                    <section className="bg-gray-50 p-10 rounded-lg shadow-xl animate-slide-up delay-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div className="flex flex-col items-center text-center p-6 bg-gray-800 rounded-lg shadow-md 
                                transition-transform hover:scale-105 duration-300 animate-zoom-in">
                            ...
                            <div className="flex flex-col items-center text-center p-6 bg-gray-800 rounded-lg shadow-md transition-transform hover:scale-105 duration-300 animate-zoom-in">
